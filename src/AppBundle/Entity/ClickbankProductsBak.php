...
/**
 * ClickbankProductsBak
 *
 * @ORM\Table(name="clickbank_products_bak", uniqueConstraints={@ORM\UniqueConstraint(name="idxcbidunique", columns={"cbid"})})
 * @ORM\Entity
 */
class ClickbankProductsBak
{
    /**
     * @var string
     *
